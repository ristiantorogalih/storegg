...
import HeadingFooter from '../../atoms/footer/heading';
            ...
            <div className="col-lg-8 mt-lg-0 mt-20">
              <div className="row gap-sm-0">
                <div className="col-md-4 col-6 mb-lg-0 mb-25">
                  <HeadingFooter heading="Company" />
                  <ul className="list-unstyled">
                    <FooterItemNavTitle navtitle="About Us" link="#" />
                    <FooterItemNavTitle navtitle="Press Release" link="#" />
                    <FooterItemNavTitle navtitle="Terms of Use" link="#" />
                    <FooterItemNavTitle navtitle="Privacy & Policy" link="#" />
                  </ul>
                </div>

                <div className="col-md-4 col-6 mb-lg-0 mb-25">
                  <HeadingFooter heading="Support" />
                  <ul className="list-unstyled">
                    <FooterItemNavTitle navtitle="Refund Policy" link="#" />
                    <FooterItemNavTitle navtitle="Unlock Rewards" link="#" />
                    <FooterItemNavTitle navtitle="Live Chat" link="#" />
                  </ul>
                </div>
                <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                  <HeadingFooter heading="Connect" />
                  <ul className="list-unstyled">
                    <FooterItemNavTitle navtitle="hi@store.gg" link="#" />
                    <FooterItemNavTitle navtitle="team@store.gg" link="#" />
                    <FooterItemNavTitle
                      navtitle="Pasific 12, Jakarta Selatan"
                      link="#"
                    />
                    <FooterItemNavTitle navtitle="021 - 1122 - 9090" link="#" />
                  </ul>
                </div>
              </div>
            </div>
